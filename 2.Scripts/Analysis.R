...
# Purpose: This script is designed  to analyze the turkey data to model nest selection
# and incubation based fate determination.
...
# Data Notes #
# there are 79 nesting events with 65 unique nesti
...
Data_CoxHaz <- subset(Data_MC, Data_MC$Nest_Type == "Nest")
